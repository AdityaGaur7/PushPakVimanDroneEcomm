                ...
                >
                  <div className="mega-dropdown-content">
                    <div className="dropdown-section">
                      ...
                      <NavLink to="/product/agriculture">Agriculture Drone</NavLink>
                      <NavLink to="/product/videography">Videography Drone</NavLink>
                    ...
                    <div className="dropdown-section">
                      ...
                      <NavLink to="/product/customised">Customised Objects</NavLink>
                      <NavLink to="/product/lithographic">Lithographic 3D Printing</NavLink>
                      <NavLink to="/product/3D">3D Printed Objects</NavLink>
                      <NavLink to="/product/educational">Educational Tools</NavLink>
                    </div>
                    <div className="dropdown-section">
                      <h6 className="dropdown-header">IOT</h6>
                      <NavLink to="/product/microcontroller">Microcontroller</NavLink>
                      <NavLink to="/product/microcomputer">Microcomputer</NavLink>
